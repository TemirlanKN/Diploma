...
int main(int argc, char **argv){
	...
	max = 0.0;
	//my_rate = 1.19;
	for (my_rate = 1.06; my_rate <= a + sigma; my_rate += 0.01){
...
double work_res(int id, int num_pr, int month, double my_rate, double crdt, double a, double sigma, int pt_count, double *time){
	int i, j;
	double rand_num, *my_sum, tmp, crdt_month = crdt / month;
	double all, *pr_sgn;
